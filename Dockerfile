...
ARG NEXT_PUBLIC_OPENAI_ORGANIZATION_ID
...
ENV NEXT_PUBLIC_OPENAI_ORGANIZATION_ID=${NEXT_PUBLIC_OPENAI_ORGANIZATION_ID}
...
# Health check goes here in the final stage
